...
import NuevoProductoDetalle from '../Productos/NuevoProductoDetalle';

function OpcionesProductosDetalle() {
  return (
...
export default OpcionesProductosDetalle;